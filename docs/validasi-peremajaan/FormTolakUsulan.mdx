...
route: /validasi-usulan-peremajaan/form-tolak-usulan
---

# Form Tolak Usulan

Pada proses validasi usulan peremajaan, terdapat
opsi untuk menolak usulan peremajaan tersebut.
Tentunya proses penolakan ini bukan tanpa alasan, sehingga
ketika sebuah usulan peremajaan ditolak, maka terdapat alasan
...
menjelaskan proses pembatalan usulan peremajaan. Pada halaman
ini terdapat informasi dari ASN yang mengajukan usulan peremajaan,
...
- Berkas salah unggah
- Masa kerja yang diajukan kurang dari satu tahun
- Akreditasi kampus C
- Masa studi melebihi batas waktu tugas belajar
- dan sebagainya

Form tolak usulan bukan merupakan komponen, dan dibuat dengan menggunakan library react-bootstrap.

### Tampilan Form Tolak Usulan

![Form Tolak Usulan](../../src/img/Form_TolakUsul.png)

### Tampilan Modal Form Tolak Usulan

![Modal Form Tolak Usulan](../../src/img/Modal_TolakUsul.png)
